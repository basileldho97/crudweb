...
export const Editdata = () => {
    ...
    const getApi = async () => {
        ...
        const useredit = await axios.get("https://crudweb-server.onrender.com/Userdata/" + uid)
    ...
    const Submituservalue = async (e) => {
        e.preventDefault();
        await axios.put("https://crudweb-server.onrender.com/Userdata/" + uid, usereditdata)
        navigate("/")
