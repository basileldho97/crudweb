...
export const Home = () => {
    ...
    const getUser = async () => {
        const result = await axios.get("https://crudweb-server.onrender.com/Userdata")
        setData(result.data)
    ...
    const deletehandle = (userid) => {
        ...
        if (answer) {
            axios.delete(`https://crudweb-server.onrender.com/Userdata/` + userid).then((res) => console.log(res))
